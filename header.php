...
<title>Not in the other language, wiktionary edition</title>
      ...
      <div class="container">
        <div class="left menu">
          <div class="title item">
            <b>Not in the other language, wiktionary edition</b>
          </div><a href="/nitolw/" class="launch item">Home</a>
                <a href="//tools.wmflabs.org/" class="launch item">Labs</a>
        </div>

        <div class="right menu">
          <a href="https://github.com/Ladsgroup/NITOLW" class="item">Source code</a>
        </div>
      </div>
    </div>
  </div>
